...
test_endpoint "GET" "/engines" "" "200" "Engines List"
...
engines=("numerology" "human_design" "tarot" "iching" "enneagram" "sacred_geometry" "biorhythm" "vimshottari" "gene_keys" "sigil_forge")

for engine in "${engines[@]}"; do
    test_endpoint "GET" "/engines/${engine}/metadata" "" "200" "${engine} metadata"
done
...
test_endpoint "POST" "/engines/numerology/calculate" "$numerology_payload" "200" "Numerology Calculation"

# Human Design Test
human_design_payload='{"input": {"birth_date": "1990-01-15", "birth_time": "14:30", "birth_location": "New York, NY"}}'
test_endpoint "POST" "/engines/human_design/calculate" "$human_design_payload" "200" "Human Design Calculation"

# Tarot Test
tarot_payload='{"input": {"question": "What should I focus on today?", "spread_type": "three_card"}}'
test_endpoint "POST" "/engines/tarot/calculate" "$tarot_payload" "200" "Tarot Calculation"

# I-Ching Test
iching_payload='{"input": {"question": "How can I find balance?", "method": "coins"}}'
test_endpoint "POST" "/engines/iching/calculate" "$iching_payload" "200" "I-Ching Calculation"

# Enneagram Test
enneagram_payload='{"input": {"assessment_answers": [1, 2, 3, 4, 5], "self_selected_type": 1}}'
test_endpoint "POST" "/engines/enneagram/calculate" "$enneagram_payload" "200" "Enneagram Calculation"

# Sacred Geometry Test
sacred_geometry_payload='{"input": {"intention": "healing", "pattern_type": "mandala"}}'
test_endpoint "POST" "/engines/sacred_geometry/calculate" "$sacred_geometry_payload" "200" "Sacred Geometry Calculation"

# Biorhythm Test
biorhythm_payload='{"input": {"birth_date": "1990-01-15", "target_date": "2024-01-15"}}'
test_endpoint "POST" "/engines/biorhythm/calculate" "$biorhythm_payload" "200" "Biorhythm Calculation"

# Vimshottari Test
vimshottari_payload='{"input": {"birth_date": "1990-01-15", "birth_time": "14:30"}}'
test_endpoint "POST" "/engines/vimshottari/calculate" "$vimshottari_payload" "200" "Vimshottari Calculation"

# Gene Keys Test
gene_keys_payload='{"input": {"birth_date": "1990-01-15", "birth_time": "14:30", "birth_location": "New York, NY"}}'
test_endpoint "POST" "/engines/gene_keys/calculate" "$gene_keys_payload" "200" "Gene Keys Calculation"

# Sigil Forge Test
sigil_forge_payload='{"input": {"intention": "I attract abundance and prosperity", "generation_method": "traditional"}}'
test_endpoint "POST" "/engines/sigil_forge/calculate" "$sigil_forge_payload" "200" "Sigil Forge Calculation"
...
test_endpoint "POST" "/batch" "$batch_payload" "200" "Batch Calculation (3 engines)"
...
# Invalid engine
test_endpoint "GET" "/engines/invalid_engine/metadata" "" "404" "Invalid Engine (404)"

# Invalid input
invalid_payload='{"input": {}}'
test_endpoint "POST" "/engines/numerology/calculate" "$invalid_payload" "400" "Invalid Input (400)"

# Invalid method
test_endpoint "PUT" "/engines/numerology/calculate" "$numerology_payload" "405" "Invalid Method (405)"
